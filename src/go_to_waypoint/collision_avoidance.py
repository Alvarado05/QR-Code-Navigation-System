...
def run(ser, hit_distance, corr_angle, velocity):
    ...
    while hit == True:
        ...
        if left < hit_distance and right > hit_distance:
            ...
            final_orientation = gtw.checkRange(final_orientation)
            gtw.alignOrientation(ser, velocity, data['IMU'][-1], final_orientation)
